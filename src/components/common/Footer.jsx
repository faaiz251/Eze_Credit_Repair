      ...
      <footer className="bg-blue-800 text-white py-1">
        <div className="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="ml-[30px] border-x border-solid p-3">
            ...
            <ul className="mt-2 space-y-1 text-sm">
              <li>
                <a href="/" className="hover:text-gray-300" onClick={() => window.location.reload()}>Home</a>
              </li>
              <li>
                <a href="/about" className="hover:text-gray-300" onClick={() => window.location.reload()}>About Us</a>
              </li>
              <li>
                <a href="/services" className="hover:text-gray-300" onClick={() => window.location.reload()}>Our Services</a>
              </li>
              <li>
                <a href="/pricing" className="hover:text-gray-300" onClick={() => window.location.reload()}>Pricing Page</a>
              </li>
              <li>
                <a href="/work" className="hover:text-gray-300" onClick={() => window.location.reload()}>How It Works</a>
              </li>
              <li>
                <a href="/learning-center" className="hover:text-gray-300" onClick={() => window.location.reload()}>Learning Center</a>
              </li>
              <li>
                <a href="/terms-and-conditions" className="hover:text-gray-300" onClick={() => window.location.reload()}>Terms and Conditions</a>
              </li>
              <li>
                <a href="/f&q" className="hover:text-gray-300" onClick={() => window.location.reload()}>FAQ</a>
              </li>
              <li>
