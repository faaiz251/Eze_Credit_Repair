    ...
    <div className="flex flex-col md:flex-row bg-blue-800 text-white p-8 rounded-sm">
      ...
      <div className="flex-1 mb-8 md:mb-0 md:mr-8">
        ...
        <form className="grid grid-cols-1 gap-4">
          ...
          <input
            type="text"
            placeholder="What is your Current Score?"
            className="p-3 rounded bg-white text-black"
          />
          <input
            type="text"
          ...
          <textarea
            ...
            className="p-3 rounded bg-white text-black h-20"
          ></textarea>
          <button className="mt-4 p-3 rounded bg-green-500 text-white font-bold">
            Sign Up Now
          </button>
        </form>
      </div>
